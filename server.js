...
// Email alıcıları için yardımcı fonksiyon
...
app.get('/', (req, res) => {
  res.send(`Welcome to ${config.hotel.name} Backend API!`);
});
// Sunucuyu başlat
const PORT = config.port;
app.listen(PORT, '0.0.0.0', () => {
  console.log(`Server for ${config.hotel.name} is running on port ${PORT}`);
});
